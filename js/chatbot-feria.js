...
window.ySocialChatInit = function () {
    ...
    function cambiarIcono() {
        contar++;
        if (contar == 1) {
            $(".icono-chat").attr('src', 'https://corporativo.compensar.com/PublishingImages/Chat/chatbot-icon-BF-open.png');
        } else {
            $(".icono-chat").attr('src', 'https://corporativo.compensar.com/PublishingImages/Chat/chatbot-icon-BF-close.png');
            contar = 0;
        }
